...
function revslider_showDoubleJqueryError(e) {
        ...
        function n(n, i) {
            ...
            if (i.forceFullWidth == "on" && n.closest(".forcefullwidth_wrapper_tp_banner")
                .length == 0) {
                var o = n.parent()
                    .offset()
                    .left;
                ...
                if (p == t) p = 0;
                n.parent()
                    .wrap('<div style="position:relative;width:100%;height:auto;margin-top:' + p + ";margin-bottom:" + u + '" class="forcefullwidth_wrapper_tp_banner"></div>');
                n.closest(".forcefullwidth_wrapper_tp_banner")
                    .append('<div class="tp-fullwidth-forcer" style="width:100%;height:' + n.height() + 'px"></div>');
                n.css({
                    backgroundColor: n.parent()
                        .css("backgroundColor"),
                    backgroundImage: n.parent()
                        .css("backgroundImage")
                });
                n.parent()
                    .css({
            ...
            try {
                if (i.hideThumbsUnderResolution > e(window)
                    .width() && i.hideThumbsUnderResolution != 0) {
                    n.parent()
            ...
            if (!n.hasClass("revslider-initialised")) {
                        ...
                        try {
                            if (e(this)
                                ...
                                e("head")
                                    ...
                                    .each(function() {
                                        if (e(this)
                                            .attr("src") == r + "://www.youtube.com/iframe_api") s = false
                                    });
                                if (s) {
                        ...
                        try {
                            if (e(this)
                                ...
                                e("head")
                                    ...
                                    .each(function() {
                                        if (e(this)
                                            .attr("src") == x + "://a.vimeocdn.com/js/froogaloop2.min.js") i = false
                                    });
                                if (i) r.parentNode.insertBefore(n, r)
                            }
                        } catch (s) {}
                    });
                n.find(".tp-caption video")
                    .each(function(t) {
                        e(this)
                ...
                if (i.shuffle == "on") {
                    for (var N = 0; N < n.find(">ul:first-child >li")
                        .length; N++) {
                        var C = Math.round(Math.random() * n.find(">ul:first-child >li")
                            .length);
                        n.find(">ul:first-child >li:eq(" + C + ")")
                            .prependTo(n.find(">ul:first-child"))
                    }
                }
                i.slots = 4;
                i.act = -1;
                ...
                if (k.length < 9) {
                    if (k.split("slide")
                        ...
                        if (L < 1) L = 1;
                        if (L > n.find(">ul:first >li")
                            .length) L = n.find(">ul:first >li")
                            .length;
                        i.next = L - 1
                    }
                }
                ...
                if (n.find(".tp-bannertimer")
                    .length == 0) n.append('<div class="tp-bannertimer" style="visibility:hidden"></div>');
                ...
                i.container = n;
                i.slideamount = n.find(">ul:first >li")
                    .length;
                ...
                if (i.shadow != 0) {
                    n.parent()
                        .append('<div class="tp-bannershadow tp-shadow' + i.shadow + '"></div>');
                    var o = 0;
                    if (i.forceFullWidth == "on") o = 0 - i.container.parent()
                        .offset()
                        .left;
                    n.parent()
                ...
                e("body")
                    .data("rs-fullScreenMode", false);
                e(window)
                    .on("mozfullscreenchange webkitfullscreenchange fullscreenchange", function() {
                        e("body")
                            .data("rs-fullScreenMode", !e("body")
                                .data("rs-fullScreenMode"));
                        if (e("body")
                            .data("rs-fullScreenMode")) {
                            setTimeout(function() {
                                e(window)
                    ...
                    .resize(function() {
                        if (e("body")
                            ...
                            if (i.forceFullWidth == "on") {
                                var t = i.container.closest(".forcefullwidth_wrapper_tp_banner")
                                    .offset()
                                    .left;
                                i.container.parent()
                                    .css({
                ...
                try {
                    if (i.hideThumbsUnderResoluition != 0 && i.navigationType == "thumb") {
                        if (i.hideThumbsUnderResoluition > e(window)
                            .width()) e(".tp-bullets")
                            .css({
                                display: "none"
                            });
        ...
        e.fn.extend({
            revolution: function(r) {
                ...
                return this.each(function() {
                    try {
                        console.groupCollapsed("Slider Revolution 4.5.7 Initialization on " + e(this)
                            .attr("id"));
        ...
        var s = function(n, r) {
            try {
                if (r.hideThumbsUnderResoluition != 0 && r.navigationType == "thumb") {
                    if (r.hideThumbsUnderResoluition > e(window)
                        .width()) e(".tp-bullets")
                        .css({
                            display: "none"
                        });
            ...
            var u = 0;
            if (r.forceFullWidth == "on") u = 0 - r.container.parent()
                .offset()
                .left;
            try {
                n.parent()
        ...
        var o = function(t, n) {
            var r = e('<div style="display:none;"/>')
                .appendTo(e("body"));
        ...
        var a = function(t, n) {
            ...
            if (n.navigationType == "bullet" || n.navigationType == "both") {
                t.parent()
                    .append('<div class="tp-bullets ' + r + " simplebullets " + n.navigationStyle + '"></div>')
            }
            var i = t.parent()
                .find(".tp-bullets");
            t.find(">ul:first >li")
                .each(function(e) {
                    var n = t.find(">ul:first >li:eq(" + e + ") img:first")
                        .attr("src");
        ...
        var f = function(e, n) {
            function a(t) {
                e.parent()
                    .append('<div style="' + i + '" class="tp-' + t + "arrow " + s + " tparrows " + o + '"><div class="tp-arr-allwrapper"><div class="tp-arr-iwrapper"><div class="tp-arr-imgholder"></div><div class="tp-arr-imgholder2"></div><div class="tp-arr-titleholder"></div><div class="tp-arr-subtitleholder"></div></div></div></div>')
            }
        ...
        var p = function(t, n) {
            ...
            if (n.navigationType == "thumb") {
                ...
                s.parent()
                    .width(n.thumbWidth * n.thumbAmount * n.bw);
                s.parent()
            ...
            if (n.navigationArrows == "nexttobullets") {
                ...
                u.insertBefore(i.find(".tpclear"))
                    .css({
                        "float": "left"
                    })
            }
            var a = 0;
            if (n.forceFullWidth == "on") a = 0 - n.container.parent()
                .offset()
                .left;
            var f = 0,
                l = 0;
            ...
            if (n.navigationArrows != "none" && n.navigationArrows != "nexttobullets") {
                ...
                if (o.position() != null) o.css({
                    top: Math.round(parseInt(o.position()
                        .top, 0)) + "px"
                });
                if (u.position() != null) u.css({
                    top: Math.round(parseInt(u.position()
                        .top, 0)) + "px"
                })
            }
        ...
        var d = function(n) {
            ...
            if (n.arr == t) {
                n.arr = r.parent()
                    .find(".tparrows"), n.rar = r.parent()
                    .find(".tp-rightarrow"), n.lar = r.parent()
                    .find(".tp-leftarrow"), n.raimg = n.rar.find(".tp-arr-imgholder"), n.laimg = n.lar.find(".tp-arr-imgholder"), n.raimg_b = n.rar.find(".tp-arr-imgholder2"), n.laimg_b = n.lar.find(".tp-arr-imgholder2"), n.ratit = n.rar.find(".tp-arr-titleholder"), n.latit = n.lar.find(".tp-arr-titleholder")
            }
            var a = n.arr,
                f = n.rar,
                l = n.lar,
        ...
        var v = function(n, r) {
            r.container.closest(".forcefullwidth_wrapper_tp_banner")
                .find(".tp-fullwidth-forcer")
                .css({
                    height: r.container.height()
                });
            r.container.closest(".rev_slider_wrapper")
                .css({
                    height: r.container.height()
                });
            ...
            if (r.fullScreen == "on") {
                ...
                if (r.fullScreenOffsetContainer != t) {
                    ...
                    try {
                        if (r.fullScreenOffset.split("%")
                            .length > 1 && r.fullScreenOffset != t && r.fullScreenOffset.length > 0) {
                            s = s - e(window)
                                .height() * parseInt(r.fullScreenOffset, 0) / 100
                        } else {
            ...
            if (r.fullScreen == "on") r.sloth = Math.ceil(e(window)
                .height() / r.slots);
            ...
            n.find(">ul:first >li >img")
                .each(function(n) {
                    ...
                    if (o(8)) {
                        ...
                        c.find(".tp-bgimg")
                            .append('<img class="ieeightfallbackimage defaultimg" src="' + s + '" style="width:100%">')
                    }
                    i.css({
                        opacity: 0
                    });
        ...
        var g = function(e, n, r, i) {
            ...
            if (i == "horizontal") {
                ...
                for (var S = 0; S < n.slots; S++) {
                    ...
                    if (a != t && f != t) punchgs.TweenLite.set(s.find(".slot")
                        .last(), {
                            rotationZ: f
                        });
                    if (o(8)) {
                        s.find(".slot ")
                            .last()
                            .find(".slotslide")
                            .append('<img class="ieeightfallbackimage" src="' + E + '" style="width:100%;height:auto">');
                        b(s, n)
                    }
                }
            } else {
        ...
        var y = function(e, n, r) {
            ...
            for (var T = 0; T < n.slots; T++) {
                ...
                for (var N = 0; N < n.slots; N++) {
                    ...
                    if (u != t && a != t) punchgs.TweenLite.set(i.find(".slot")
                        .last(), {
                            rotationZ: a
                        })
                }
        ...
        var T = function(e, n) {
            ...
            if (u.data("lazyload") != t && u.data("lazyload") != "undefined" && u.data("lazydone") != 1) {
                if (!o(8)) u.css({
                    backgroundImage: 'url("' + s.find(".defaultimg")
                        .data("lazyload") + '")'
                });
                else {
                    u.attr("src", s.find(".defaultimg")
                        .data("lazyload"))
                }
                u.data("src", s.find(".defaultimg")
                    .data("lazyload"));
                u.data("lazydone", 1);
                u.data("orgw", 0);
                s.data("loadeddone", 1);
        ...
        var k = function(n, r, i, s, u, a) {
                ...
                a.find(".slotslide")
                    .each(function(t) {
                        ...
                        D.add(punchgs.TweenLite.fromTo(n, C / 1e3, {
                            ...
                            left: 0 + "px",
                            top: 0 - t * r.sloth + "px",
                            width: a.find(".defaultimg")
                                .data("neww") + "px",
                            height: a.find(".defaultimg")
                                .data("newh") + "px",
                            opacity: 1,
                            rotation: 0
                        }), 0);
            ...
            if (f == 16) {
                ...
                s.find(".tp-half-two")
                    .removeClass("tp-half-one");
                var F = r.width;
                var I = r.height;
                if (r.autoHeight == "on") I = n.height();
                s.find(".tp-half-one .defaultimg")
                    .wrap('<div class="tp-papercut" style="width:' + F + "px;height:" + I + 'px;"></div>');
                s.find(".tp-half-two .defaultimg")
                    .wrap('<div class="tp-papercut" style="width:' + F + "px;height:" + I + 'px;"></div>');
                s.find(".tp-half-two .defaultimg")
                    .css({
                        position: "absolute",
                ...
                k.add(punchgs.TweenLite.fromTo(s.find(".tp-half-two"), C / 800, {
                    ...
                    onComplete: function() {
                        ...
                        if (s.find(".tp-half-one")
                            .length > 0) {
                            s.find(".tp-half-one .defaultimg")
                                .unwrap();
                            s.find(".tp-half-one .slotholder")
                                .unwrap()
                        }
                        s.find(".tp-half-two")
                            .remove()
            ...
            r.addEvent("ready", function(e) {
                ...
                r.addEvent("play", function(e) {
                    ...
                    if (i.closest(".tp-caption")
                        .data("volume") == "mute") r.api("setVolume", "0")
                });
        ...
        var B = function(n, r, i, s) {
            ...
            var o = n.data("ctl"),
                ...
                a = 0,
                f = n.find(".tp-caption"),
                l = r.container.find(".tp-static-layers")
                .find(".tp-caption");
            o.pause();
                ...
                if (h == 0) {
                            ...
                            f.click(function() {
                                ...
                                if (n != "next" && n != "prev") {
                                    ...
                                    r.container.parent()
                                        .find(".tp-rightarrow")
                                        .click()
                                } else if (n == "next") r.container.parent()
                                    .find(".tp-rightarrow")
                                    .click();
                                else if (n == "prev") r.container.parent()
                                    .find(".tp-leftarrow")
                                    .click()
                            })
                        }
                    ...
                    if (f.find("iframe")
                        ...
                        f.find("iframe")
                            .each(function() {
                                ...
                                if (f.data("thumbimage") != t && f.data("thumbimage")
                                    .length > 2 && f.data("autoplay") != true && !s) {
                                    f.find(".tp-thumb-image")
                                        .remove();
                        ...
                        if (f.find("video")
                            ...
                            f.find("video")
                                .each(function(n) {
                                    ...
                                    if (i.attr("poster") != t && o.find(".tp-poster")
                                        .length == 0) o.append('<div class="tp-poster" style="position:absolute;z-index:1;width:100%;height:100%;top:0px;left:0px;background:url(' + i.attr("poster") + '); background-position:center center;background-size:100%;background-repeat:no-repeat;"></div>');
                                    if (i.attr("control") == t && o.find(".tp-video-play-button")
                                        .length == 0) {
                                        o.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><div class="tp-revstop"></div></div>');
                                        o.find(".tp-video-play-button")
                                            .click(function() {
                                    ...
                                    o.data("interval", setInterval(function() {
                                        if (o.data("metaloaded") == 1 || s.duration != NaN) {
                                            ...
                                            if (f.data("dottedoverlay") != "none" && f.data("dottedoverlay") != t)
                                                if (f.find(".tp-dottedoverlay")
                                                    .length != 1) o.append('<div class="tp-dottedoverlay ' + f.data("dottedoverlay") + '"></div>');
                                            var n = 16 / 9;
                                            if (f.data("aspectratio") == "4:3") n = 4 / 3;
                                            o.data("mediaAspect", n);
                                            if (o.closest(".tp-caption")
                                                .data("forcecover") == 1) {
                                                _(o, r.container);
                                                o.addClass("fullcoveredvideo")
                                            }
                    ...
                    if (f.find("img")
                        ...
                        if (f.find("iframe")
                            ...
                            f.find(".tp-resizeme, .tp-resizeme *")
                                .each(function() {
                                    I(e(this), r)
                                });
                    ...
                    if (!s) {
                        ...
                        if (r.fullScreenAlignForce == "on") {}
                        var Z = f;
                        if (f.data("mySplitText") != t) f.data("mySplitText")
                            .revert();
                        if (f.data("splitin") == "chars" || f.data("splitin") == "words" || f.data("splitin") == "lines" || f.data("splitout") == "chars" || f.data("splitout") == "words" || f.data("splitout") == "lines") {
                            if (f.find("a")
                                .length > 0) f.data("mySplitText", new punchgs.SplitText(f.find("a"), {
                                type: "lines,words,chars",
                                charsClass: "tp-splitted",
                                wordsClass: "tp-splitted",
                                linesClass: "tp-splitted"
                            }));
                            else if (f.find(".tp-layer-inner-rotation")
                                .length > 0) f.data("mySplitText", new punchgs.SplitText(f.find(".tp-layer-inner-rotation"), {
                                type: "lines,words,chars",
                                charsClass: "tp-splitted",
                                wordsClass: "tp-splitted",
                                linesClass: "tp-splitted"
                        ...
                        if (f.data("splitin") == "chars") Z = f.data("mySplitText")
                            .chars;
                        if (f.data("splitin") == "words") Z = f.data("mySplitText")
                            .words;
                        if (f.data("splitin") == "lines") Z = f.data("mySplitText")
                            .lines;
                        var et = D();
                        var tt = D();
            ...
            n.find(".rs-pendulum")
                .each(function() {
                    ...
                    if (n.data("timeline") == t) {
                        ...
                        s = s * r;
                        n.data("timeline")
                            .append(new punchgs.TweenLite.fromTo(n, speed, {
                                force3D: "auto",
                                rotation: i,
            ...
            n.find(".rs-wave")
                .each(function() {
                    ...
                    if (n.data("timeline") == t) {
                        ...
                        n.data("timeline")
                            .append(new punchgs.TweenLite.fromTo(a, o, {
                                a: 360
                            }, {
                                a: 0,
                                force3D: "auto",
        ...
        var R = function(n) {
            n.find(".rs-pendulum, .rs-slideloop, .rs-pulse, .rs-wave")
                .each(function() {
                    var n = e(this);
                    if (n.data("timeline") != t) {
                        n.data("timeline")
        ...
        var U = function(n, r) {
            ...
            var s = n.find(".tp-caption"),
                o = r.container.find(".tp-static-layers")
                .find(".tp-caption");
        ...
        var z = function(e, n, r, i, s) {
            ...
            var a = e;
            if (r.typ == "chars") a = e.data("mySplitText")
                .chars;
            else if (r.typ == "words") a = e.data("mySplitText")
                .words;
            else if (r.typ == "lines") a = e.data("mySplitText")
                .lines;
        ...
        var W = function(e, n, r, i, s, o) {
            ...
            if (e.hasClass("ltr") || e.hasClass("ltl") || e.hasClass("str") || e.hasClass("stl") || e.hasClass("ltt") || e.hasClass("ltb") || e.hasClass("stt") || e.hasClass("stb") || e.hasClass("skewtoright") || e.hasClass("skewtorightshort") || e.hasClass("skewtoleft") || e.hasClass("skewtoleftshort") || e.hasClass("fadeout") || e.hasClass("randomrotateout")) {
                ...
                var c = e;
                var c = e;
                if (e.data("splitout") == "chars") c = e.data("mySplitText")
                    .chars;
                else if (e.data("splitout") == "words") c = e.data("mySplitText")
                    .words;
                else if (e.data("splitout") == "lines") c = e.data("mySplitText")
                    .lines;
        ...
        var $ = function() {
            ...
            var t = false;
            for (i in e) {
                if (navigator.userAgent.split(e[i])
                    .length > 1) {
                    t = true
                }
            }
        ...
        var K = function(n, r, i, s) {
            ...
            l.find(".defaultimg")
                .each(function() {
                    var t = e(this);
                    if (l.find(".kenburnimg")
                        .length == 0) l.append('<div class="kenburnimg" style="position:absolute;z-index:1;width:100%;height:100%;top:0px;left:0px;"><img src="' + t.attr("src") + '" style="-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;position:absolute;width:' + T.w + "%;height:" + T.h + '%;"></div>');
                    else {
        ...
        var Y = function(n, r) {
            ...
            n.find(".defaultimg")
                .each(function() {
                    ...
                    if (n != t && n.data("kenburn img") != t && n.data("kenburn img")
                        .length > 0) punchgs.TweenLite.set(n.data("kenburn img"), {
                        autoAlpha: 0
                    })
                })
        };
        var Z = function(t, n) {
            ...
            t.find(">ul:first-child >li")
                .each(function() {
                    var t = e(this);
                    for (var r = 1; r <= 10; r++) t.find(".rs-parallaxlevel-" + r)
                        .each(function() {
                            var t = e(this);
        ...
        var tt = function(n, r) {
            ...
            o.parent()
                .width(r.thumbWidth * r.thumbAmount);
            o.parent()
                .height(r.thumbHeight);
            n.find(">ul:first >li")
                .each(function(e) {
                    var i = n.find(">ul:first >li:eq(" + e + ")");
                    var o = i.find(".defaultimg")
                        .css("backgroundColor");
                    if (i.data("thumb") != t) var u = i.data("thumb");
                    else var u = i.find("img:first")
                        .attr("src");
                ...
                s.parent()
                    .mouseenter(function() {
                        ...
                        var i = e("body")
                            .data("mousex") - r.left;
                        var s = t.width();
                        var o = t.find(".bullet:first")
                            .outerWidth(true);
                        var u = o * n.find(">ul:first >li")
                            .length;
                        var a = u - s + 15;
                        var f = a / s;
                        i = i - 30;
        ...
        var nt = function(e) {
            ...
            var n = t.parent();
            var r = n.offset();
            var i = n.find(".bullet:first")
                .outerWidth(true);
            var s = n.find(".bullet.selected")
                .index() * i;
            var o = n.width();
            var i = n.find(".bullet:first")
                .outerWidth(true);
            var u = i * e.find(">ul:first >li")
                .length;
            var a = u - o;
            var f = a / o;
            var l = 0 - s;
