...
window.Typekit.config = {
    "a": "1901155",
    "f": "//use.typekit.net/c/c79c59/1w;ff-meta-web-pro,91bb0f3ff63f08e0231b70c26ae52273fd9ebe9e44615be7cb7255ccb832a97e,ZG4:R:i4,ZGB:R:i7,ZG3:R:n4,ZG9:R:n7/{format}{/extras*}?",
    "fi": [4648, 4649, 4650, 4651],
    "fn": ["ff-meta-web-pro", ["i4", "i7", "n4", "n7"]],
    "ht": "tk",
    "js": "1.12.8",
    "k": "//use.typekit.net/{id}.js",
    "kt": "beg1hqp",
    "p": "//p.typekit.net/p.gif?s=1&k=beg1hqp&ht=tk&h={host}&f=4648.4649.4650.4651&a=1901155&_={_}",
    "ps": 1,
    "w": "beg1hqp"
};
/*{"k":"1.12.8","last_published":"2015-03-09 13:35:01 UTC","auto_updating":true}*/
;
(function(window, document, undefined) {
    ...
    n.prototype.compare = function(a) {
        return this.m > a.m || this.m === a.m && this.r > a.r || this.m === a.m && this.r === a.r && this.Q > a.Q ? 1 : this.m < a.m || this.m === a.m && this.r < a.r || this.m === a.m && this.r === a.r && this.Q < a.Q ? -1 : 0
    };
    ...
    var oa = new y("Unknown", new n, "Unknown", new n, "Unknown", new n, void 0, new m(!1));
    na.prototype.parse = function() {
        ...
        if (-1 != this.b.indexOf("MSIE") || -1 != this.b.indexOf("Trident/")) {
            ...
            var b = u(A(this)),
                ...
                f = C(this.T),
                c = -1 != this.b.indexOf("MSIE") ? u(B(this.b, /MSIE ([\d\w\.]+)/, 1)) : u(B(this.b, /rv:([\d\w\.]+)/, 1));
            "" != e ? (d = "Trident", e = u(e)) : (d = "Unknown", e = new n);
            a = new y("MSIE", c, d, e, a, b, f, new m(!1))
        } else if (-1 != this.b.indexOf("Opera")) a: if (a = "Unknown", b = u(B(this.b, /Presto\/([\d\w\.]+)/, 1)), c = u(A(this)), d = C(this.T), null !==
                b.m ? a = "Presto" : (-1 != this.b.indexOf("Gecko") && (a = "Gecko"), b = u(B(this.b, /rv:([^\)]+)/, 1))), -1 != this.b.indexOf("Opera Mini/")) f = u(B(this.b, /Opera Mini\/([\d\.]+)/, 1)), a = new y("OperaMini", f, a, b, z(this), c, d, new m(!1));
            else {
                if (-1 != this.b.indexOf("Version/") && (f = u(B(this.b, /Version\/([\d\.]+)/, 1)), null !== f.m)) {
                    a = new y("Opera", f, a, b, z(this), c, d, new m(!1));
                    break a
                }
                f = u(B(this.b, /Opera[\/ ]([\d\.]+)/, 1));
                a = null !== f.m ? new y("Opera", f, a, b, z(this), c, d, new m(!1)) : new y("Opera", new n, a, b, z(this), c, d, new m(!1))
            } else /OPR\/[\d.]+/.test(this.b) ?
            a = pa(this) : /AppleWeb(K|k)it/.test(this.b) ? a = pa(this) : -1 != this.b.indexOf("Gecko") ? (a = "Unknown", b = new n, c = u(A(this)), -1 != this.b.indexOf("Firefox") ? (a = "Firefox", b = u(B(this.b, /Firefox\/([\d\w\.]+)/, 1))) : -1 != this.b.indexOf("Mozilla") && (a = "Mozilla"), d = u(B(this.b, /rv:([^\)]+)/, 1)), a = new y(a, b, "Gecko", d, z(this), c, C(this.T), new m(!1))) : a = oa;
        return a
    };

    function z(a) {
        var b = B(a.b, /(iPod|iPad|iPhone|Android|Windows Phone|BB\d{2}|BlackBerry)/, 1);
        if ("" != b) return /BB\d{2}/.test(b) && (b = "BlackBerry"), b;
        a = B(a.b, /(Linux|Mac_PowerPC|Macintosh|Windows|CrOS|PlayStation|CrKey)/, 1);
        return "" != a ? ("Mac_PowerPC" == a ? a = "Macintosh" : "PlayStation" == a && (a = "Linux"), a) : "Unknown"
    }

    function A(a) {
        var b = B(a.b, /(OS X|Windows NT|Android) ([^;)]+)/, 2);
        if (b || (b = B(a.b, /Windows Phone( OS)? ([^;)]+)/, 2)) || (b = B(a.b, /(iPhone )?OS ([\d_]+)/, 2))) return b;
        if (b = B(a.b, /(?:Linux|CrOS|CrKey) ([^;)]+)/, 1))
            for (var b = b.split(/\s/), c = 0; c < b.length; c += 1)
                if (/^[\d\._]+$/.test(b[c])) return b[c];
        return (a = B(a.b, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2)) ? a : "Unknown"
    }
    ...
    function pa(a) {
        ...
        "BuiltinBrowser" ==
        e ? f = "Unknown" : "Silk" == e ? f = B(a.b, /Silk\/([\d\._]+)/, 1) : "Chrome" == e ? f = B(a.b, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2) : -1 != a.b.indexOf("Version/") ? f = B(a.b, /Version\/([\d\.\w]+)/, 1) : "AdobeAIR" == e ? f = B(a.b, /AdobeAIR\/([\d\.]+)/, 1) : "Opera" == e ? f = B(a.b, /OPR\/([\d.]+)/, 1) : "PhantomJS" == e && (f = B(a.b, /PhantomJS\/([\d.]+)/, 1));
        f = u(f);
        return new y(e, f, "AppleWebKit", d, b, c, C(a.T), new m(536 > d.m || 536 == d.m && 11 > d.r))
    }
    ...
    function G(a, b) {
        this.e = a;
        this.P = b;
        this.q = this.e.createElement("span", {
            "aria-hidden": "true"
        }, this.P)
    }
    ...
    function H(a) {
        ...
        return "display:block;position:absolute;top:-9999px;left:-9999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:" + b + ";" + ("font-style:" + c + ";font-weight:" + (a.fa + "00") + ";")
    }
    ...
    function va(a) {
        var b = a.B.q.offsetWidth,
            c = a.C.q.offsetWidth;
        b === a.D.serif && c === a.D["sans-serif"] || a.F.wa && wa(a, b, c) ? ca() - a.Ka >= a.ea ? a.F.wa && wa(a, b, c) && (null === a.qa || a.qa.hasOwnProperty(a.u.getName())) ? xa(a, a.ga) : xa(a, a.Fa) : ya(a) : xa(a, a.ga)
    }
    ...
    za.prototype.Ca = function(a) {
        var b = this.H;
        b.J && l(b.v, [b.o.h(b.p, a.getName(), E(a).toString(), "active")], [b.o.h(b.p, a.getName(), E(a).toString(), "loading"), b.o.h(b.p, a.getName(), E(a).toString(), "inactive")]);
        D(b, "fontactive", a);
        this.va = !0;
        Aa(this)
    };
    ...
    function Aa(a) {
        0 == --a.ca && a.oa && (a.va ? (a = a.H, a.J && l(a.v, [a.o.h(a.p, "active")], [a.o.h(a.p, "loading"), a.o.h(a.p, "inactive")]), D(a, "active")) : sa(a.H))
    }
    ...
    Ea.prototype.toString = function() {
        for (var a = [], b = 0; b < this.t.length; b++)
            for (var c = this.t[b], d = c.I(), c = c.I(this.s), e = 0; e < d.length; e++) {
                var f;
                a: {
    ...
    function Ha(a, b, c) {
        for (var d = [], e = a.N.split(",")[0].replace(/"|'/g, ""), f = a.I(), g, k = [], v = {}, x = 0; x < f.length; x++) g = f[x], 0 < g.length && !v[g] && (v[g] = !0, k.push(g));
        c = c.ua ? c.ua(e, k, d) : k;
        a.la[b] = c;
        a.ka[b] = d
    }
    ...
    function Ia(a, b) {
        for (var c = a.I(b), d = a.ka[b] || [], e = [], f = 0; f < c.length; f++) e.push(new F(a.N, c[f]));
    ...
    Ka.prototype.send = function(a, b, c) {
        var d = new N("//p.typekit.net/p.gif?s={service}&k={token}&app={app}&ht={hosting}&h={host}&f={variations}&a={account}&sl={stylesheetLoadTime}&fl={fontLoadTime}&js={version}&_={_}"),
            e = encodeURIComponent((window.__adobewebfontsappname__ || this.Aa || "").toString().substr(0, 20)),
    ...
    function P(a) {
        return O(a) && s(a.g, new n(5, 1)) || O(a) && s(a.g, new n(5, 2)) || O(a) && s(a.g, new n(6, 0)) || O(a) && r(a.g, new n(6, 1))
    }
    ...
    function Ta(a) {
        return "Safari" === a.getName() && "AppleWebKit" === a.M || "Unknown" === a.getName() && "AppleWebKit" === a.M && ("iPhone" === a.n || "iPad" === a.n || "iPod" === a.n)
    }
    ...
    X.prototype.load = function(a, b, c) {
        ...
        f.active = function() {
            M.stop();
            e.ra && e.ra.send(e.e, -1 !== w.R && -1 !== w.K ? w.K - w.R : -1, -1 !== M.R && -1 !== M.K ? M.K - M.R : -1);
            d()
        };
        x = new ra(this.e, f);
        if (this.s) {
            for (var f = Xa[this.s] || new Va(Wa), q = 0; q < this.t.length; q++) Ha(this.t[q], this.s, f);
            this.ba && (f = Ya(this.e, this.s, this.t), f = Fa(this.s, f), f.contextPath = g, k && (f.hostname =
                k), g = this.ba.h("https:" === ha(this.e), f), w.start(), ka(this.e, g, function() {
                w.stop();
                M.start()
            }, c));
            if (v) {
                for (var S = [], La = {}, t = new za(this.b, this.e, x, a), q = 0; q < this.t.length; q++) S = S.concat(Ia(this.t[q], this.s));
                for (q = 0; q < S.length; q++) La[S[q].getName()] = "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006";
                fa(this.e, function() {
                    var a = S,
                        c = {},
                        d = La || {};
                    if (0 === a.length && b) sa(t.H);
                        ...
                        for (var e = 0; e < a.length; e++) {
                            var f = a[e],
                                ...
                                k = t.H,
                                q = f;
                            k.J && l(k.v, [k.o.h(k.p, q.getName(),
                                E(q).toString(), "loading")]);
                            D(k, "fontloading", q);
                            k = null;
    ...
    Za.prototype.load = function(a, b) {
        ...
        if (c.length)
            for (var e = this, f = c.length, g = 0; g < c.length; g++) $a(this, c[g], function() {
                0 == --f && ab(e, d)
            });
        else ab(this, d)
    };
    ...
    function ab(a, b) {
        if (0 != a.w.length) {
            for (var c = new ra(a.e, b), d = !1, e = 0; e < a.w.length; e++) a.w[e].init(), d = d || a.w[e].supportsConfiguredBrowser();
            if (d)
                for (c.J && l(c.v, [c.o.h(c.p, "loading")]), D(c, "loading"), c = 0; c < a.w.length; c++) d = a.w[c], d.supportsConfiguredBrowser() && d.load(null, c == a.w.length - 1, b);
            else sa(c);
            a.w = []
        }
    }
    ...
    var gb, Y, Z, K = window.Typekit.config || {};
    Z = new X(cb);
    ...
    if (K.c)
        for (L = 0; L < K.c.length; L += 2) Z.S.push(new Ba);
    Z.b = bb;
    var hb;
    a: {
        var ib = Z.b,
